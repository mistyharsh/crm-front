...
import { type RegisteredRouter, type LinkProps, Link } from '@tanstack/react-router';
...
export const ButtonAsLink = forwardRef<HTMLAnchorElement, Props>(function ButtonAsLink(props, ref) {
  const { ...rest } = props;
